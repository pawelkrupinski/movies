...
object RecordSwitchedToCorpus {
  def main(args: Array[String]): Unit = {
    ...
    rep("KinoBajkaKluczbork")(new Bilety24OrganizerClient(record, "https://www.bilety24.pl/kino/organizator/kino-bajka-w-kluczborku-1467", KinoBajkaKluczbork, titles = titleNormalizer).fetch().size)
    ...
    rep("KinoWawel")(new Bilety24OrganizerClient(record, "https://www.bilety24.pl/kino/organizator/kino-wawel-w-lubaniu-1489", KinoWawel, titles = titleNormalizer).fetch().size)
    ...
    rep("KinoFregata")(new Bilety24OrganizerClient(record, "https://www.bilety24.pl/kino/organizator/leborskie-centrum-kultury-kino-fregata-1683", KinoFregata, titles = titleNormalizer).fetch().size)
    rep("KinoNarie")(new Bilety24OrganizerClient(record, "https://www.bilety24.pl/kino/organizator/kino-narie-w-moragu-1682", KinoNarie, titles = titleNormalizer).fetch().size)
    rep("KinoPiastOstrzeszow")(new Bilety24OrganizerClient(record, "https://www.bilety24.pl/kino/organizator/kino-piast-w-ostrzeszowie-601", KinoPiastOstrzeszow, titles = titleNormalizer).fetch().size)
    rep("KinoHel")(new Bilety24OrganizerClient(record, "https://www.bilety24.pl/kino/organizator/kino-hel-dom-kultury-w-pleszewie-1255", KinoHel, titles = titleNormalizer).fetch().size)
    ...
    rep("KinoPionierZary")(new Bilety24OrganizerClient(record, "https://www.bilety24.pl/kino/organizator/kino-pionier-w-zarach-1492", KinoPionierZary, titles = titleNormalizer).fetch().size)
    rep("KinoKDK")(new Bilety24OrganizerClient(record, "https://www.bilety24.pl/kino/organizator/kino-kutnowskiego-domu-kultury-1474", KinoKDK, titles = titleNormalizer).fetch().size)
    rep("KinoSokolDabrowaTarnowska")(new Bilety24OrganizerClient(record, "https://www.bilety24.pl/kino/organizator/kino-sokol-w-dabrowie-tarnowskiej-1303", KinoSokolDabrowaTarnowska, titles = titleNormalizer).fetch().size)
    rep("KinoWislaBrzeszcze")(new Bilety24OrganizerClient(record, "https://www.bilety24.pl/kino/organizator/kino-wisla-w-brzeszczach-1539", KinoWislaBrzeszcze, titles = titleNormalizer).fetch().size)
    ...
    rep("KinoGornik")(new Bilety24OrganizerClient(record, "https://www.bilety24.pl/kino/organizator/kino-gornik-szydlowiec-1320", KinoGornik, titles = titleNormalizer).fetch().size)
    ...
    rep("KinoBaszta")(new Bilety24OrganizerClient(record, "https://www.bilety24.pl/kino/organizator/kino-baszta-477", KinoBaszta, titles = titleNormalizer).fetch().size)
    rep("KinoCentrumBialogard")(new Bilety24OrganizerClient(record, "https://www.bilety24.pl/kino/organizator/kino-centrum-w-bialogardzie-1685", KinoCentrumBialogard, titles = titleNormalizer).fetch().size)
    ...
    rep("KinoKalejdoskop")(new SystemBiletowyClient(record, "https://ckp.systembiletowy.pl", KinoKalejdoskop, titles = titleNormalizer).fetch().size)
