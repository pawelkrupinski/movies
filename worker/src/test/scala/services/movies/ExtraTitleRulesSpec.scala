...
class ExtraTitleRulesSpec extends AnyFlatSpec with Matchers {
  ...
  private val programmeCases = Seq(
    ...
    // each banner kept a film off TMDB entirely ("Big Festivalowski: Zaproszenie" alone
    // covered 22 rows), because the query went out with the banner still attached.
    "Big Festivalowski: Zaproszenie"                  -> ("Big Festivalowski: ",              "Zaproszenie"),
    "Big Festivalowski: Najgorszy człowiek na świecie" -> ("Big Festivalowski: ",             "Najgorszy człowiek na świecie"),
    "Lato w Lunie: Vaiana 2"                          -> ("Lato w Lunie: ",                   "Vaiana 2"),
    "Lato z Rafael Film: Amadeusz"                    -> ("Lato z Rafael Film: ",             "Amadeusz"),
    "Lato w Mieście 2026: Moon. Panda i ja"           -> ("Lato w Mieście 2026: ",            "Moon. Panda i ja"),
    "Lato z Młodymi Horyzontami: Arco"                -> ("Lato z Młodymi Horyzontami: ",     "Arco"),
    "Wakacyjne Środy z klasyką: Absolwent"            -> ("Wakacyjne Środy z klasyką: ",      "Absolwent"),
    "Wakacje w Kinie Orzeł: Vaiana 2"                 -> ("Wakacje w Kinie Orzeł: ",          "Vaiana 2"),
    "Filmowe popołudnie dla dzieci: Obóz sportowy"    -> ("Filmowe popołudnie dla dzieci: ",  "Obóz sportowy"),
    "Bajkowe poranki: Kicia Kocia na pikniku"         -> ("Bajkowe poranki: ",                "Kicia Kocia na pikniku"),
    "Rodzina w kinie: Vaiana 2"                       -> ("Rodzina w kinie: ",                "Vaiana 2"),
    "Filmy górskie: Arco"                             -> ("Filmy górskie: ",                  "Arco"),
