...
class CinemaScraperCatalog(
  ...
  private val filmwebExtra: Map[String, Seq[CinemaScraper]] = Map(
    ...
    "szczecin" -> Seq(new FilmwebShowtimesClient(http, 117, KinoKawiarnia, today = today), new BiletynaClient(bnFetch, "https://biletyna.pl/Pyrzyce/Pyrzycki-Dom-Kultury", KinoPDK), new BiletynaClient(bnFetch, "https://biletyna.pl/Stargard/Stargardzkie-Centrum-Kultury", KinoSCK)),
    "bialystok" -> Seq(new BiletynaClient(bnFetch, "https://biletyna.pl/Sokolka/Kino-Sokol", KinoSokolSokolka)),
    "trojmiasto" -> Seq(new BiletynaClient(bnFetch, "https://biletyna.pl/Gdansk/Kino-na-Szekspirowskim", KinoNaSzekspirowskim), new FilmwebShowtimesClient(http, 1464, MultikinoRumia, today = today)),
    "bydgoszcz" -> Seq(new MsiClient(http, "https://bilety.kinomax.info.pl", KinoKinomax, today), new FilmwebShowtimesClient(http, 3121, KinoRondo, today = today)),
    ...
    "bielsko-biala" -> Seq(new Bilety24OrganizerClient(http, "https://www.bilety24.pl/kino/organizator/kino-janosik-1500", KinoJanosik), new FilmwebShowtimesClient(http, 3248, KinoPckulKino, today = today), new BiletynaClient(bnFetch, "https://biletyna.pl/Czechowice-Dziedzice/Kino-Swit", KinoSwitCzechowiceDziedzice), new BiletynaClient(bnFetch, "https://biletyna.pl/Skoczow/Teatr-Elektryczny", KinoTeatrElektryczny), new Bilety24OrganizerClient(http, "https://www.bilety24.pl/kino/organizator/kino-wisla-w-brzeszczach-1539", KinoWislaBrzeszcze), new FilmwebShowtimesClient(http, 1776, MultikinoCzechowiceDziedzice, today = today)),
    "opole" -> Seq(new FilmwebShowtimesClient(http, 1703, HeliosKedzierzynKozle, today = today), new Bilety24OrganizerClient(http, "https://www.bilety24.pl/kino/organizator/kino-bajka-w-kluczborku-1467", KinoBajkaKluczbork), new FilmwebShowtimesClient(http, 619, KinoChemik, today = today), new FilmwebShowtimesClient(http, 2343, KinoDiana, today = today), new Bilety24OrganizerClient(http, "https://www.bilety24.pl/kino/organizator/krapkowicki-dom-kultury-1244", KinoKrapkowice), new FilmwebShowtimesClient(http, 431, KinoStudio, today = today), new FilmwebShowtimesClient(http, 1672, KinoTwierdza, today = today)),
    "rybnik" -> Seq(new FilmwebShowtimesClient(http, 2326, HeliosZory, today = today), new Bilety24OrganizerClient(http, "https://www.bilety24.pl/kino/organizator/kino-baltyk-1499", KinoBaltyk), new FilmwebShowtimesClient(http, 514, KinoCentrum, today = today), new FilmwebShowtimesClient(http, 588, KinoNaStarowce, today = today), new BiletynaClient(bnFetch, "https://biletyna.pl/Wodzislaw-Slaski/Wodzislawskie-Centrum-Kultury", KinoPegaz), new TeatrZiemiRybnickiejClient(http)),
    "elblag" -> Seq(new FilmwebShowtimesClient(http, 1673, HeliosTczew, today = today), new Bilety24OrganizerClient(http, "https://www.bilety24.pl/kino/organizator/kino-baszta-477", KinoBaszta), new MsiClient(http, "https://kinosztumbilety.pl", KinoPowisle, today), new BiletynaClient(bnFetch, "https://biletyna.pl/Nowy-Dwor-Gdanski/Zulawski-Osrodek-Kultury", KinoZulawskiOsrodekKultury)),
    "koszalin" -> Seq(new MsiClient(http, "https://darlowo.vectorsoft.pl", KinoBajkaDarlowo, today), new Bilety24OrganizerClient(http, "https://www.bilety24.pl/kino/organizator/kino-centrum-w-bialogardzie-1685", KinoCentrumBialogard), new BiletynaClient(bnFetch, "https://biletyna.pl/Slawno/Slawienski-Dom-Kultury", KinoDK), new MsiClient(http, "https://bilety.goktychowo.pl", KinoGOK, today), new MsiClient(http, "https://bilety.ckpolczyn.pl", KinoGoplana, today), new MsiClient(http, "https://bilety.rck.kolobrzeg.pl", KinoWybrzeze, today)),
    "kalisz" -> Seq(new FilmwebShowtimesClient(http, 2372, HeliosOstrowWlkp, today = today), new FilmwebShowtimesClient(http, 1513, KinoCentrum3D, today = today), new Bilety24OrganizerClient(http, "https://www.bilety24.pl/kino/organizator/kino-echo-w-jarocinie-1159", KinoEcho), new Bilety24OrganizerClient(http, "https://www.bilety24.pl/kino/organizator/kino-piast-w-ostrzeszowie-601", KinoPiastOstrzeszow), new Bilety24OrganizerClient(http, "https://www.bilety24.pl/kino/organizator/krotoszynski-osrodek-kultury-1668", KinoPrzedwiosnieKrotoszyn)),
    "zielona-gora" -> Seq(new Bilety24OrganizerClient(http, "https://www.bilety24.pl/kino/organizator/nowosolski-dom-kultury-1679", KinoEuropa), new FilmwebShowtimesClient(http, 2171, KinoMaxKino, today = today), new Bilety24OrganizerClient(http, "https://www.bilety24.pl/kino/organizator/kino-pionier-w-zarach-1492", KinoPionierZary), new MsiClient(http, "https://bilety.kino.swiebodzin.pl:4433", KinoSDKSwiebodzin, today)),
    ...
    "walbrzych" -> Seq(new MsiClient(http, "https://bilety.nowaruda.pl", KinoMOKNowaRuda, today), new FilmwebShowtimesClient(http, 197, KinoMOKiS, today = today), new KinoSlezaClient(http, KinoSleza), new BiletynaClient(bnFetch, "https://biletyna.pl/Dzierzoniow/Kinoteatr-Zbyszek", KinoZbyszek), new FilmwebShowtimesClient(http, 2990, MultikinoKlodzko, today = today), new FilmwebShowtimesClient(http, 2993, MultikinoSwidnica, today = today)),
    "tarnow" -> Seq(new SystemBiletowyClient(http, "https://kfb.systembiletowy.pl", KinoFarys), new BiletynaClient(bnFetch, "https://biletyna.pl/Solec-Zdroj/Kino-Solec-Zdroj", KinoGCK), new Bilety24OrganizerClient(http, "https://www.bilety24.pl/kino/organizator/gorlickie-centrum-kultury-1581", KinoKolory), new MsiClient(http, "https://rezerwacja.planetabrzesko.pl", KinoPlaneta, today, mvcPath = "/Rezerwacja/mvc/pl"), new FilmwebShowtimesClient(http, 2419, KinoPromien, today = today), new FilmwebShowtimesClient(http, 1294, KinoRegis, today = today), new Bilety24OrganizerClient(http, "https://www.bilety24.pl/kino/organizator/kino-sokol-w-dabrowie-tarnowskiej-1303", KinoSokolDabrowaTarnowska)),
    ...
    "legnica" -> Seq(new FilmwebShowtimesClient(http, 1420, HeliosLubin, today = today), new KinoAurumClient(http, KinoAurum), new CyfroweKinoClient(http, KinoCyfroweKino), new FilmwebShowtimesClient(http, 373, KinoForumBoleslawiec, today = today), new Bilety24OrganizerClient(http, "https://www.bilety24.pl/kino/organizator/centrum-kultury-muza-w-lubinie-1375", KinoMuzaLubin), new Bilety24OrganizerClient(http, "https://www.bilety24.pl/kino/organizator/centrum-kultury-w-polkowicach-1689", KinoPCA)),
    "plock" -> Seq(new Bilety24OrganizerClient(http, "https://www.bilety24.pl/kino/organizator/kino-kutnowskiego-domu-kultury-1474", KinoKDK), new SystemBiletowyClient(http, "https://ckp.systembiletowy.pl", KinoKalejdoskop), new FilmwebShowtimesClient(http, 2128, KinoODEON, today = today)),
    "nowy-sacz" -> Seq(new FilmwebShowtimesClient(http, 561, KinoJaworzyna, today = today), new Bilety24OrganizerClient(http, "https://www.bilety24.pl/kino/organizator/limanowski-dom-kultury-1368", KinoKlaps)),
    ...
    "przemysl" -> Seq(new FilmwebShowtimesClient(http, 1786, KinoCentrum3DPrzemysl, today = today), new MsiClient(http, "https://kinoikar.mok-jar.pl", KinoIkar, today), new MsiClient(http, "https://jaroslaw.kinonabiegunach.pl", KinoNaBiegunach, today), new FilmwebShowtimesClient(http, 2118, KinoSDK, today = today)),
  )
