...
import models.{Cinema, CinemaMovie, Helios, HeliosAlejaBielany, HeliosBlueCity, HeliosForum, HeliosKatowice, HeliosMagnolia, HeliosMetropolia, HeliosRiviera, Movie, Showtime}
