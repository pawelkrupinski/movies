...
locals {
  primary_ips = {
    ...
    monitoring_1_ipv4 = { type = "ipv4", location = "nbg1" }
    monitoring_1_ipv6 = { type = "ipv6", location = "nbg1" }
    k3s_worker_1_ipv4 = { type = "ipv4", location = "hel1" }
    k3s_worker_1_ipv6 = { type = "ipv6", location = "hel1" }
  }
}
