...
object Cities {
    val all: List<City> = listOf(
        ...
        City("piotrkow-trybunalski", "Piotrków Trybunalski", 51.4055, 19.7032, "pl"),
        City("siedlce", "Siedlce", 52.1677, 22.2901, "pl"),
        City("pila", "Piła", 53.1514, 16.7378, "pl"),
        City("ostrowiec-swietokrzyski", "Ostrowiec Świętokrzyski", 50.9294, 21.3852, "pl"),
        City("gniezno", "Gniezno", 52.5348, 17.5826, "pl"),
        City("suwalki", "Suwałki", 54.1118, 22.9309, "pl"),
        City("stalowa-wola", "Stalowa Wola", 50.5829, 22.0533, "pl"),
        City("zamosc", "Zamość", 50.7231, 23.2520, "pl"),
        City("leszno", "Leszno", 51.8403, 16.5749, "pl"),
        City("lomza", "Łomża", 53.1781, 22.0593, "pl"),
        City("pulawy", "Puławy", 51.4166, 21.9694, "pl"),
        City("skierniewice", "Skierniewice", 51.9549, 20.1584, "pl"),
        City("starogard-gdanski", "Starogard Gdański", 53.9640, 18.5264, "pl"),
        City("ciechanow", "Ciechanów", 52.8814, 20.6200, "pl"),
        City("wielun", "Wieluń", 51.2210, 18.5696, "pl"),
        City("chojnice", "Chojnice", 53.6955, 17.5570, "pl"),
        City("zgorzelec", "Zgorzelec", 51.1494, 15.0084, "pl"),
        City("ilawa", "Iława", 53.5960, 19.5685, "pl"),
        City("ketrzyn", "Kętrzyn", 54.0768, 21.3753, "pl"),
