...
//   `DetailsStore.swift`, `CountrySwitch.swift` and `ConditionalListEndpoint.swift` ride along under the same `#if canImport` guard.
...
let networkingTargets: [Target] = [
    .target(
        ...
        sources: [
            ...
            "Networking/ConditionalListEndpoint.swift",
        ]
    ),
    .testTarget(
