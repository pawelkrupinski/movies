...
class FilmHrefSpec extends AnyFlatSpec with Matchers {
  ...
  "FilmHref" should "produce a /{city}/movie/{slug} URL" in {
    FilmHref("Belle") shouldBe "/poznan/movie/belle"
  }
  ...
  it should "fold spaces, punctuation, and diacritics into the slug" in {
    ...
    FilmHref("Mandalorian i Grogu") shouldBe "/poznan/movie/mandalorian-i-grogu"
    FilmHref("Gwiezdne Wojny: Mandalorian i Grogu") shouldBe
      "/poznan/movie/gwiezdne-wojny-mandalorian-i-grogu"
    FilmHref("Diabeł ubiera się u Prady 2") shouldBe
      "/poznan/movie/diabel-ubiera-sie-u-prady-2"
  }
  ...
  it should "fall back to the query form when a title has no usable slug" in {
    ...
    FilmHref("!!!") shouldBe "/poznan/movie?title=%21%21%21"
