...
object StagingTaskKeys {
  ...
  private def anchor(title: String, normalizer: TitleNormalizer): String = normalizer.sanitize(title)
  ...
  def detailDedup(title: String, cinemaDisplayName: String, normalizer: TitleNormalizer): String = detailKey(anchor(title, normalizer), cinemaDisplayName)
  def resolveTmdbDedup(title: String, normalizer: TitleNormalizer): String = s"staging-tmdb|${anchor(title, normalizer)}"
  ...
  def resolveImdbDedup(title: String, normalizer: TitleNormalizer): String = imdbKey(anchor(title, normalizer))
  ...
  // per-year fan-out.
  def foldDedup(title: String, normalizer: TitleNormalizer): String = s"staging-fold|${anchor(title, normalizer)}"

  def detailPayload(title: String, cinemaDisplayName: String, normalizer: TitleNormalizer): Map[String, String] =
  ...
  def anchorOf(payload: Map[String, String], normalizer: TitleNormalizer): String = anchor(titleOf(payload), normalizer)
