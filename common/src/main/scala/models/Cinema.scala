...
case object OdeonCinemaCamdenTown extends Cinema("Odeon Cinema Camden Town", "Odeon Camden Town")
...
case object VueCinemasCroydonGrantS extends Cinema("Vue Cinemas Croydon Grant's", "Vue Croydon Grant's")
...
case object VueCinemasShepherdSBush extends Cinema("Vue Cinemas Shepherd's Bush", "Vue Shepherd's Bush")
...
case object VueCinemasCardiff extends Cinema("Vue Cinemas Cardiff", "Vue Cardiff")
...
case object CineworldFriarsWalkNewport extends Cinema("Cineworld (Friars Walk) Newport", "Cineworld (Friars Walk) Newport")
...
case object CurzonCanterburyWestgate extends Cinema("Curzon Canterbury Westgate", "Curzon Canterbury Westgate")
...
case object OmniplexArmagh extends Cinema("Omniplex Armagh", "Omniplex Armagh")
...
case object CurzonCinemaSheffield extends Cinema("Curzon Cinema Sheffield", "Curzon Sheffield")
...
object Cinema {
  ...
  val cardiff: Seq[Cinema] = Seq(ChapterCardiff, CineworldCardiff, EverymanCinemaCardiff, OdeonCinemaCardiff, ShowcaseCinemaCardiff, VueCinemasCardiff)
  ...
  val gwent: Seq[Cinema] = Seq(BakerStreetCinemaAbergavenny, CineworldFriarsWalkNewport, CineworldSpyttyParkNewport, MarketHallCinemaBrynmawr, MaximeCinemaBlackwood, RiverfrontNewport, SavoyTheatreMonmouth, VueCinemasCwmbran)
  ...
  val kent: Seq[Cinema] = Seq(CarltonCinemaWestgateOnSea, CinemarshTheMarshAcademy, CineworldAshford, CineworldDover, CineworldRochester, CurzonCanterburyRiverside, CurzonCanterburyWestgate, EmpireCinemaSandwich, GulbenkianTheatre, KavanaghCinemaHerneBay, KinoHawkhurst, OdeonCinemaChatham, OdeonCinemaMaidstone, OdeonCinemaTunbridgeWells, PalaceCinemaKent, RoyalCinemaFaversham, ShowcaseDeLuxBluewater, SilverScreenFolkestone, StagSevenoaks, TheAshfordCinemaFormerlyPicturehouse, TheLightSittingbourne, TheWoodvilleGravesend, VueCinemasThanetWestwoodCross)
  ...
  val tyrone: Seq[Cinema] = Seq(OmniplexArmagh, OmniplexDungannon, OmniplexOmagh, RitzMultiplexCookstown)
  ...
  val yorkshire: Seq[Cinema] = Seq(CineworldSheffield, CurzonCinemaSheffield, OdeonLuxeSheffield, ParamountPenistone, ShowroomSheffield, TheLightSheffield, VueCinemasSheffield)
