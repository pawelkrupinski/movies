...
class AppComponents(context: Context)
  ...
  // ── Router + filters ──────────────────────────────────────────────────────
  lazy val accessLogFilter: tools.AccessLogFilter = new tools.AccessLogFilter()(materializer, executionContext)
  override def httpFilters: Seq[EssentialFilter] = super.httpFilters :+ corsFilter :+ accessLogFilter
