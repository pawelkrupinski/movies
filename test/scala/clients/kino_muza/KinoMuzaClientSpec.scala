...
class KinoMuzaClientSpec extends AnyFlatSpec with Matchers {
  ...
  it should "return correct production country for every movie" in {
    byTitle("Barbara Forever").movie.country shouldBe Some("USA")
    byTitle("Bez końca").movie.country shouldBe Some("Polska, Francja")
    byTitle("Bez znieczulenia").movie.country shouldBe Some("Polska")
    byTitle("Bibliotekarki").movie.country shouldBe Some("USA")
    byTitle("Broken English").movie.country shouldBe Some("Wielka Brytania")
    byTitle("Brzezina").movie.country shouldBe Some("Polska")
    byTitle("Był sobie śnieg").movie.country shouldBe Some("Austria")
    byTitle("Chronologia wody").movie.country shouldBe Some("Francja, Łotwa, USA")
    byTitle("Co ukrywa Elon Musk?").movie.country shouldBe Some("Niemcy")
    byTitle("Człowiek z marmuru").movie.country shouldBe Some("Polska")
    byTitle("Drama").movie.country shouldBe Some("USA")
    byTitle("Dziecko z pyłu").movie.country shouldBe Some("Polska, Wietnam, Szwecja, Czechy, Katar")
    byTitle("Dzikie szaleństwo").movie.country shouldBe Some("Słowacja, Czechy")
    byTitle("Efekt architektury").movie.country shouldBe Some("Austria")
    byTitle("FILMOCZULE DLA EDUKACJI z ODN i WZiSS UMP – Babystar").movie.country shouldBe Some("Niemcy")
    byTitle("Fałszerz stulecia").movie.country shouldBe Some("Francja")
    byTitle("Freak Show").movie.country shouldBe Some("Polska")
    byTitle("Gala Wręczenia Nagrody Wolności | Pieśni lasu").movie.country shouldBe Some("Francja")
    byTitle("Giulietta i duchy").movie.country shouldBe Some("Włochy, Francja")
    byTitle("Guru").movie.country shouldBe Some("Francja")
    byTitle("Głos z księżyca").movie.country shouldBe Some("Włochy")
    byTitle("Habibi Hussein").movie.country shouldBe Some("Palestyna, Niemcy, Arabia Saudyjska, Szwecja")
    byTitle("Hamnet").movie.country shouldBe Some("Wielka Brytania")
    byTitle("Idź z duszą na dłoni").movie.country shouldBe Some("Francja, Palestyna, Iran")
    byTitle("Istoty czujące").movie.country shouldBe Some("Australia")
    byTitle("Jak głęboka jest twoja miłość?").movie.country shouldBe Some("USA")
    byTitle("Jak zrobić film o betonie").movie.country shouldBe Some("USA")
    byTitle("Jane Elliot kontra reszta świata").movie.country shouldBe Some("USA")
    byTitle("Kandydaci Śmierci").movie.country shouldBe Some("Polska")
    byTitle("Krajobraz po bitwie").movie.country shouldBe Some("Polska")
    byTitle("Kronika wypadków miłosnych").movie.country shouldBe Some("Polska")
    byTitle("Kłopotliwy niedźwiedź").movie.country shouldBe Some("USA, Kanada, Wielka Brytania")
    byTitle("Layla").movie.country shouldBe Some("Wielka Brytania")
    byTitle("Mam rzekę we krwi").movie.country shouldBe Some("Norwegia")
    byTitle("Mariinka").movie.country shouldBe Some("Belgia, Niderlandy")
    byTitle("Mi Amor").movie.country shouldBe Some("Francja")
    byTitle("Milcząca przyjaciółka").movie.country shouldBe Some("Niemcy, Francja, Węgry")
    byTitle("Miłość, która zostaje").movie.country shouldBe Some("Islandia, Dania, Szwecja, Francja")
    byTitle("Moi Themersonowie").movie.country shouldBe Some("Polska")
    byTitle("Młodsza siostra").movie.country shouldBe Some("Francja, Niemcy")
    byTitle("Najstarsza osoba na świecie").movie.country shouldBe Some("USA")
    byTitle("Nie oglądaj się teraz").movie.country shouldBe Some("Wielka Brytania, Włochy")
    byTitle("Niedźwiedzica").movie.country shouldBe Some("Norwegia, Niemcy")
    byTitle("Noce Cabirii").movie.country shouldBe Some("Włochy, Francja")
    byTitle("Nomadland").movie.country shouldBe Some("USA")
    byTitle("Nowa fala").movie.country shouldBe Some("Francja, USA")
    byTitle("Nurt").movie.country shouldBe Some("Polska")
    byTitle("O czasie i wodzie").movie.country shouldBe Some("Islandia, USA")
    byTitle("Obcy").movie.country shouldBe Some("francja")
    byTitle("Orwell: 2 + 2 = 5").movie.country shouldBe Some("Francja, USA")
    byTitle("Osiem i pół").movie.country shouldBe Some("Włochy, Francja")
    byTitle("Pan Nikt kontra Putin").movie.country shouldBe Some("Dania, Czechy")
    byTitle("Pieniądze to wszystko").movie.country shouldBe Some("Irlandia, Dania")
    byTitle("Pieśni lasu").movie.country shouldBe Some("Francja")
    byTitle("Poczta głosowa").movie.country shouldBe Some("Francja")
    byTitle("Pomiędzy woskiem i złotem").movie.country shouldBe Some("Austria,Włochy")
    byTitle("Proszę nie siadać").movie.country shouldBe Some("Polska")
    byTitle("Przeżyj to sam").movie.country shouldBe Some("Francja")
    byTitle("Romería").movie.country shouldBe Some("Hiszpania")
    byTitle("Runa Simi").movie.country shouldBe Some("Peru")
    byTitle("Sny o słoniach").movie.country shouldBe Some("USA")
    byTitle("Sygnalista").movie.country shouldBe Some("Niemcy")
    byTitle("Słodkie życie").movie.country shouldBe Some("Włochy, Francja")
    byTitle("Top Gun").movie.country shouldBe Some("USA")
    byTitle("Uciszone").movie.country shouldBe Some("Australia")
    byTitle("Wałkonie").movie.country shouldBe Some("Włochy, Francja")
    byTitle("Wielki Łuk").movie.country shouldBe Some("Francja")
    byTitle("Windą na szafot").movie.country shouldBe Some("Francja")
    byTitle("Wolność po włosku").movie.country shouldBe Some("Francja, Włochy")
    byTitle("Wpatrując się w słońce").movie.country shouldBe Some("Niemcy")
    byTitle("Wspinaczka").movie.country shouldBe Some("Austria, USA")
    byTitle("Wszyscy na Kenmure Street").movie.country shouldBe Some("Wielka Brytania, Katar")
    ...
    byTitle("Żądło").movie.country shouldBe Some("USA")
  }
